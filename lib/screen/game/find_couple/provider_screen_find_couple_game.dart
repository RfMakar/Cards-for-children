...
//Игра "Найди пару"
class ProviderScreenFindCoupleGame extends ChangeNotifier {
  ProviderScreenFindCoupleGame(this.idTable) {
    loadGame();
  }
  final int idTable;
  ...
  final clickColorCard = ColorsApp.menuGame; //Цвет нажатия на карточку
